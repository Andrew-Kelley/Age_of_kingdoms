...
#
# (a) wood, stone, etc. to be collected by villagers are represented by (instances of)
# their respective classes, which inherit from the Resource class.
#
# (b) Also, the amount of resources a player has is represented by a modified dictionary
# (an instance of the class Resources below). Also, the cost of building/researching anything
# in the game is also represented as an instance of the Resources class.

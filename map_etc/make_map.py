...
for i in range(40, 60):
    for j in range(40, 60):
        game_map.bldngs_n_rsrcs[i][j] = Stone(Position(j, i))
...
game_map.bldngs_n_rsrcs[50][99] = Iron(Position(99, 50))
